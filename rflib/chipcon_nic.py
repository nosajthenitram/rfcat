...
class FHSSNIC(NICxx11):
    ...
    def setMACperiod(self, dwell_ms, mhz=24):
        ...
        self.poke(X_T2PR, PR)
        self.poke(X_T2CTL, t2ctl)
        self.poke(X_CLKCON, clkcon)
